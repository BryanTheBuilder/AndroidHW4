/**
 * Bryant's Contribution
 * I worked on creating the switch method for input and suggested what framework we would have in our linked list
 * where we added and removed the strings
 */
